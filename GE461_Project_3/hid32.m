...
%Network parameters
N_hidden = 32; %Number of hiddden layer neurons
std_hid = 0.01;
std_out = 0.01;
...
%     x = [x;1];
%     v_hid_te = W_hid*x;
%     y_hid_te = sigmoid(v_hid_te);
%     y_hid_te = [y_hid_te; 1];
%     v_out_te = W_out*y_hid_te;
%     y_out_test_te(i) = v_out_te;
...
save("hid32out.mat", "y_out_train","-ascii");
